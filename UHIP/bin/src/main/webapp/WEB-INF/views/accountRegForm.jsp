...
$(document).ready(function() {
	$("#emailId").blur(function() {
		var entemail = $("#emailId").val();
		$("#btnSubmit").attr("disabled",false);
		$("#errEmail").html("");
		$.ajax({
			url : window.location + "regForm/checkEmail",
			type : "GET",
			data : {
				"email" : entemail
			},
			success : function(data){
				if(data=='duplicate'){
					$("#errEmail").html("Email already registered");
...
body {
	background-image:
		url("https://images.unsplash.com/photo-1511895426328-dc8714191300?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80");
	fixed;
...
<body>
	<div>
		<form:form action="regForm" modelAttribute="modelObj" role="form">
			...
			<h1>Account Registration</h1>
			   ${regMsg}
				...
				<form:input type="text" path="email" placeholder="Enter Email"
					id="emailId" />
				<i class="fa fa-envelope fa-lg fa-fw" aria-hidden="true"></i> <font
					color="red"><span id="errEmail"></span></font>
			</div>
				...
				Phone Number
				<div class="inputWithIcon">
				<form:input type="text" path="phNumber"
